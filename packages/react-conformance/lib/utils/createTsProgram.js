 ...
 */ export function createTsProgram(sourcePath, options = {}) {
    ...
    if (!program) {
        ...
        const tsconfigPath = ts.findConfigFile(configDir !== null && configDir !== void 0 ? configDir : sourcePath, fs.existsSync, configName);
        if (!tsconfigPath) {
